...
4. For **push**: require `docs/pm/jira/OVERVIEW.md` with at least one epic; at least one task file under `docs/pm/jira/tasks/todo/` (or user confirms delta on existing files); user must confirm push in session.
